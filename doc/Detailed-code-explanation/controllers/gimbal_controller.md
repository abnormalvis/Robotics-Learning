...
## gimbal\_controller[](#gimbal-controller "Permalink to this heading")

## 1\. 运行流程[](#id1 "Permalink to this heading")

## 2\. 代码详解[](#id2 "Permalink to this heading")

### 1\. gimbal\_base.h[](#gimbal-base-h "Permalink to this heading")
...
### 2\. gimbal\_base.cpp[](#gimbal-base-cpp "Permalink to this heading")

#### 1\. update()[](#update "Permalink to this heading")
...
#### 2\. 状态机中的模式[](#id3 "Permalink to this heading")

##### 1\. rate[](#rate "Permalink to this heading")

##### 2\. track[](#track "Permalink to this heading")
...
##### 3\. direct[](#direct "Permalink to this heading")
...
#### 3\. setDes()[](#setdes "Permalink to this heading")
...
#### 4\. moveJoint()[](#movejoint "Permalink to this heading")
...
### 3\. bullet\_solver.cpp[](#bullet-solver-cpp "Permalink to this heading")

#### 1\. solve[](#solve "Permalink to this heading")

1.  从参数的实时buffer中获取参数
    
2.  通过函数传入的参数，给变量target\_pos（目标点位置）、bullet\_speed（弹速）赋值
    
3.  resistance\_coff（发射过程中的阻力系数）的赋值
